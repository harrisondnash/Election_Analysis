...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes:
        ...
        if (votes > largest_county_count) and (percentage > winning_percentage):
    ...
    largest_turnout_results = (
        f"-------------------------\n"
        f"Winning County Votes:\n"
        f"-------------------------\n"
        f"{largest_county} : {largest_county_count:,} \n\n" 
        f"Candidate Votes:\n\n"
    )

    print(largest_turnout_results, end="")
